...
function numberOfCharacters(string) {
   ...
   arr.forEach(function(elemento) {
     if (Object.keys(obj).includes(elemento)) {
       obj[elemento] += 1;
     } else {
       obj[elemento] = 1;
     }
...
function capicua(numero) {
   ...
   var reverseNumStr = reverseNumArr.join("");
